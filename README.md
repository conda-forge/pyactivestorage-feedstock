About pyactivestorage-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyactivestorage-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyactivestorage-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pyactivestorage
# for installing globally
pixi global install pyactivestorage
```
...
It is possible to list all of the versions of `pyactivestorage` available on your platform:
...
```
pixi search pyactivestorage --channel conda-forge
```
